...
const renderCarTitle = (item, loggedIn, favs, favOnChange) => {
        ...
        <List
            ...
            renderItem={item => (
                <List.Item style = {{ marginRight: '20px'}}>
                    <Card
                    tile={renderCarTitle(item, loggedIn, favs, favOnChange)}
                    >
...
const Home=({resources, loggedIn, favoriteItems, favoriteOnChange}) => {
    ...
    return (
        ...
        >
           ...
           <TabPane tab="Clips" key={tabKeys.Clips} style={{height: '680px', overflow: 'auto'}} 
           forceRender={true}>
